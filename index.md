...
* **Lenguajes de Programación:** `JavaScript` y `TypeScript` (_se privilegió el uso de este último_).
* **Frameworks y Librerías de Front-End:** `HTML5`, `CSS3`, `Vite`, `Bootstrap`, `React` y `React Router DOM`.
* **APIs y Comunicación con el Servidor:*+ `Fetch API`, `Axios` y `API REST`.
* **Autenticación y Seguridad:** `JWT (JSON Web Tokens)` y `API Keys`.
* **Testing:** pruebas automatizadas como `pruebas unitarias` y `pruebas de integración`.
* **Control de Versiones y Colaboración:** `GitHub`.
* **Integración Continua y DevOps:** fundamentos de `CI/CD` (integración y entrega continua) utilizando `Docker` y `GitHub Actions`.
* **Gestión de Proyectos y Comunicación:** `Scrum` y `Kanban` como fundamentos de desarrollo Agile para la gestión de proyectos.
...
### Documentos: [_Front-End-M3-AE1-Documento-Análisis_](./Front-End-M3-AE1.pdf)
...
### Documentos: [_Front-End-M4-AE1-Documento-Análisis_](./Front-End-M4-AE1.pdf)
...
[![Github](data:image/png;base64,)](https://github.com/mespinozacl/) [![LinkeInBranching](https://pngimg.com/uploads/linkedIn/linkedIn_PNG11.png)](https://linkedin.com/in/matiasespinoza)
